...
namespace QL_Sinh_Vien {
    ...
    public partial class myDBDataSet4 : global::System.Data.DataSet {
        ...
        public partial class stdDataTable : global::System.Data.TypedTableBase<stdRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public stdRow AddstdRow(int Id, string fname, string lname, System.DateTime bdate, string gender, string phone, string address, byte[] picture, string MSSV) {
        ...
        public partial class stdRow : global::System.Data.DataRow {
            ...
            public string MSSV {
                get {
                    try {
                        return ((string)(this[this.tablestd.MSSVColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'MSSV\' in table \'std\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablestd.MSSVColumn] = value;
                }
            }
            ...
            public bool IsMSSVNull() {
                return this.IsNull(this.tablestd.MSSVColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetMSSVNull() {
                this[this.tablestd.MSSVColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace QL_Sinh_Vien.myDBDataSet4TableAdapters {
    ...
    public partial class stdTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[std] ([Id], [fname], [lname], [bdate], [gender], [phone], [address], [picture], [MSSV]) VALUES (@Id, @fname, @lname, @bdate, @gender, @phone, @address, @picture, @MSSV);
SELECT Id, fname, lname, bdate, gender, phone, address, picture, MSSV FROM std WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[std] SET [Id] = @Id, [fname] = @fname, [lname] = @lname, [bdate] = @bdate, [gender] = @gender, [phone] = @phone, [address] = @address, [picture] = @picture, [MSSV] = @MSSV WHERE (([Id] = @Original_Id) AND ((@IsNull_fname = 1 AND [fname] IS NULL) OR ([fname] = @Original_fname)) AND ((@IsNull_lname = 1 AND [lname] IS NULL) OR ([lname] = @Original_lname)) AND ((@IsNull_bdate = 1 AND [bdate] IS NULL) OR ([bdate] = @Original_bdate)) AND ((@IsNull_gender = 1 AND [gender] IS NULL) OR ([gender] = @Original_gender)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_MSSV = 1 AND [MSSV] IS NULL) OR ([MSSV] = @Original_MSSV)));
SELECT Id, fname, lname, bdate, gender, phone, address, picture, MSSV FROM std WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::QL_Sinh_Vien.Properties.Settings.Default.myDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, fname, lname, bdate, gender, phone, address, picture, MSSV FROM dbo.st" +
                "d";
        ...
        public virtual int Fill(myDBDataSet4.stdDataTable dataTable) {
        ...
        public virtual myDBDataSet4.stdDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            myDBDataSet4.stdDataTable dataTable = new myDBDataSet4.stdDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(myDBDataSet4.stdDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_fname, string Original_lname, global::System.Nullable<global::System.DateTime> Original_bdate, string Original_gender, string Original_phone, string Original_address, string Original_MSSV) {
            ...
            if ((Original_MSSV == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[14].Value = ((string)(Original_MSSV));
            }
        ...
        public virtual int Insert(int Id, string fname, string lname, global::System.Nullable<global::System.DateTime> bdate, string gender, string phone, string address, byte[] picture, string MSSV) {
        ...
        public virtual int Update(
                    ...
                    string Original_address, 
                    string Original_MSSV) {
            return this.Update(Original_Id, fname, lname, bdate, gender, phone, address, picture, MSSV, Original_Id, Original_fname, Original_lname, Original_bdate, Original_gender, Original_phone, Original_address, Original_MSSV);
        }
    }
