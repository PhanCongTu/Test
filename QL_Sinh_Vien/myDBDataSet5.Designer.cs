...
namespace QL_Sinh_Vien.myDBDataSet5TableAdapters {
...
SELECT Id, fname, lname, bdate, gender, phone, address, picture, MSSV FROM std WHERE (Id = @Id)";
        ...
        public virtual int Fill(myDBDataSet5.stdDataTable dataTable) {
        ...
        public virtual myDBDataSet5.stdDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            myDBDataSet5.stdDataTable dataTable = new myDBDataSet5.stdDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(myDBDataSet5.stdDataTable dataTable) {
